...
document.querySelector("#cards").innerHTML = ` 
    ...
    ${createCard('01/12', 'Quinta',createGame('croatia','12:00','belgium') + createGame('canada','12:00','marocco')+ createGame('japan','16:00','spain')+ createGame('costa rica','16:00','germany'))}
